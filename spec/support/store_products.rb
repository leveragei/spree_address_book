shared_context "store products" do
  before :each do
    ...
    create(:custom_product, name: 'Ruby on Rails Ringer T-Shirt', price: '17.99', taxons: [clothing_taxon])
    create(:custom_product, name: 'Ruby on Rails Mug', price: '13.99', taxons: [mugs_taxon])
  end
end
...
shared_context "user with address" do
  ...
  let!(:address) do
    create(:address, address1: Faker::Address.street_address, state: state)
  end
